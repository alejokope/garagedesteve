...
export function buildFabTemplateVars(payload: FloatingContactPayload): FabTemplateVars {
...
export function computeFloatingContactPublic(payload: FloatingContactPayload): FloatingContactPublic {
  ...
  const vars = buildFabTemplateVars(payload);
...
export function computeFloatingContactPublicFromDefaults(): FloatingContactPublic {
  return computeFloatingContactPublic(mergeFloatingContactDefaults(null));
}
