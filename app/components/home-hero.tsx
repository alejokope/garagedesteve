    ...
    <section className="relative overflow-hidden border-b border-[var(--border)] bg-[linear-gradient(180deg,#ffffff_0%,#fafafa_100%)]">
      <div className="relative mx-auto grid max-w-6xl gap-10 px-4 pb-16 pt-12 sm:gap-12 sm:px-8 sm:pb-20 sm:pt-16 lg:grid-cols-2 lg:items-center lg:gap-14">
        <div className="motion-safe:fade-up order-2 max-w-xl lg:order-1">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            <Link
              ...
              className="inline-flex h-12 min-w-[9.5rem] items-center justify-center rounded-lg bg-neutral-950 px-8 text-sm font-semibold text-white shadow-[0_12px_40px_-16px_rgba(0,0,0,0.25)] transition hover:bg-neutral-800 active:scale-[0.99]"
            >
              {data.primaryCta.label}
            </Link>
            <Link
              href={data.secondaryCta.href}
              className="group inline-flex items-center justify-center gap-1.5 text-sm font-semibold text-neutral-700 underline-offset-4 transition hover:text-neutral-950 hover:underline"
            >
        ...
        <div className="relative order-1 flex justify-center lg:order-2 lg:justify-end">
          <div
            aria-hidden
            className="absolute -right-8 top-1/2 h-[min(90vw,28rem)] w-[min(90vw,28rem)] -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(0,0,0,0.06)_0%,transparent_68%)]"
          />
