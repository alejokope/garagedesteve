...
const steps = [
  {
    ...
    body: "Con el botón de abajo abrís el chat con un mensaje modelo. Completá modelo, capacidad y estado real del equipo para el plan canje.",
  },
  {
    title: "Te pasamos el valor de canje",
    body: "Según modelo, capacidad, desgaste y si está liberado y sin iCloud, te respondemos con un valor orientativo dentro del plan.",
  },
  {
    title: "Coordinamos el canje",
    body: "Si te cierra la referencia, acordamos entrega o retiro y los detalles del canje sin vueltas.",
  },
] as const;
    ...
    <div className="border-b border-[var(--border)] bg-white">
      <div className="mx-auto max-w-5xl px-4 pb-16 pt-[calc(4rem+env(safe-area-inset-top))] sm:px-8 sm:pb-20 sm:pt-20 lg:pt-24">
        ...
        <h1 className="mt-3 font-display text-balance text-3xl font-semibold leading-tight tracking-tight text-neutral-950 sm:text-4xl">
          Valor de canje claro para tu equipo
        </h1>
        <p className="mt-5 text-[15px] leading-relaxed text-neutral-600 sm:text-lg">
          El <strong className="font-semibold text-neutral-950">plan canje</strong> arma una referencia según las{" "}
          <strong className="font-semibold text-neutral-950">características de tu celular o dispositivo</strong>{" "}
          (modelo, capacidad, año) y el{" "}
          <strong className="font-semibold text-neutral-950">estado real</strong>: pantalla, marcos, batería, si está
          liberado y sin iCloud, y qué accesorios incluye. Con eso te pasamos un{" "}
          <strong className="font-semibold text-neutral-950">valor orientativo por WhatsApp</strong>, sin compromiso.
          También podés usar la{" "}
          <strong className="font-semibold text-neutral-950">experiencia guiada</strong> de abajo y guardar referencias
          en{" "}
        ...
        {whatsappHref ? (
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            >
              ...
              Consultar valor de canje por WhatsApp
            </a>
            <Link
              href="/tienda"
        ...
        <section className="mt-16 border-t border-[var(--border)] pt-14">
          <h2 className="font-display text-xl font-semibold text-neutral-950 sm:text-2xl">Cómo funciona el plan canje</h2>
        ...
        <section className="mt-14">
          <h2 className="font-display text-xl font-semibold text-neutral-950 sm:text-2xl">
            {sellPricing.evaluationTitle}
          </h2>
          <p className="mt-3 text-sm leading-relaxed text-neutral-600">{sellPricing.evaluationIntro}</p>
          <ul className="mt-6 space-y-3 text-sm text-neutral-700">
            {sellPricing.evaluationCriteria.filter((item) => item.trim()).map((item, idx) => (
              <li key={`${idx}-${item.slice(0, 24)}`} className="flex gap-3">
        ...
        {whatsappHref ? (
          <div className="mt-14 rounded-2xl border border-[var(--border)] bg-[#fafafa] p-6 sm:p-8">
            <p className="text-center font-display text-lg font-semibold text-neutral-950">
              ¿Querés saber el valor de canje?
            </p>
            <p className="mt-2 text-center text-sm text-neutral-600">
              Abrí WhatsApp, completá el mensaje y en breve te pasamos la referencia del plan.
            </p>
